...
//     require!(
//         ctx.accounts.policy_program.key() == ctx.accounts.wallet_state.policy_program_id,
...
//     #[account(
//         mut,
//         seeds = [crate::constants::SMART_WALLET_SEED, wallet_state.wallet_id.to_le_bytes().as_ref()],
...
//     #[account(mut, address = wallet_state.referral_address)]
