...
export function getAddAuthorityInstructionDataEncoder(): Encoder<AddAuthorityInstructionDataArgs> {
...
export function getAddAuthorityInstructionDataDecoder(): Decoder<AddAuthorityInstructionData> {
...
export function getAddAuthorityInstructionDataCodec(): Codec<
...
> = {
  ...
  payload: AddAuthorityInstructionDataArgs["payload"];
};
